...
<body>
    <div class="center-text">
        <h1><p style="background-color:mediumspringgreen;"> | W E L C O M E |
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
                <h2><p style="background-color:mediumspringgreen;"> TENTANG SAYA
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Horizontal Rule</title>
...
<body>
    ...
    <p></p>
            ...
            <p>Lulusan S5 Roam universitas Hogwarts dan tertarik untuk bekerja di bidang permakroan. Berpengalaman sebagai staf sihir Hogwarts selama 2 abad penuh (tanpa digaji). Memiliki kemampuan menghilangkan debuff pada rekan satu tim menggunakan tongkat sihir nabi musa. </p>
             <h2><p style="background-color:mediumspringgreen;"> PROFESI DAN PEKERJAAN
            <h4>ROAMER</h4>
        ...
        <li>Menyusun daftar member baru</li>
             ...
             <h2><p style="background-color:mediumspringgreen;"> BAKAT ATAU BIDANG
            <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Horizontal Rule</title>
...
<body>
 ...
 <li>Farming (opsional)</li>
         <h2><p style="background-color:mediumspringgreen;"> SEKOLAH
        <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Horizontal Rule</title>
